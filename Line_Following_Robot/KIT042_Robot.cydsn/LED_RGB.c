 ...
 * PWM_RG, PWM_G, and PWM_B. Their outputs should be inverted because the LEDs on
...
void LED_RGB_DCWrite(uint8 LED_Color, uint16 LED_NewDutyCycle)
{
    ...
    {
    case LED_RED:
        PWM_LED_RG_WriteCompare1(LED_NewDutyCycle);
        break;
    case LED_GREEN:
        PWM_LED_RG_WriteCompare2(LED_NewDutyCycle);
        break;
    case LED_BLUE:
        PWM_LED_B_WriteCompare(LED_NewDutyCycle);
        break;
    default:
        break;
    }
    ...
    {
    case LED_RED:
        PWM_LED_RG_WriteCompare1(LED_NewDutyCycle>>8);
        break;
    case LED_GREEN:
        PWM_LED_RG_WriteCompare2(LED_NewDutyCycle>>8);
        break;
    case LED_BLUE:
        PWM_LED_B_WriteCompare(LED_NewDutyCycle>>8);
        break;
    default:
        break;
    }
