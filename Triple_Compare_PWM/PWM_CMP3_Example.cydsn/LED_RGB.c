...
void LED_RGB_DCWrite(uint8 LED_Color, uint16 LED_NewDutyCycle)
{
    ...
    {
    case LED_RED:
        PWM_3CMP_1_WriteIntensity0((uint8)(LED_NewDutyCycle>>8));
        break;
    case LED_GREEN:
        PWM_3CMP_1_WriteIntensity1((uint8)(LED_NewDutyCycle>>8));
        break;
    case LED_BLUE:
        PWM_3CMP_1_WriteIntensity2((uint8)(LED_NewDutyCycle>>8));
        break;
    default:
        break;
    }
