...
#define SysTimers_RESOLUTION       10000
#define SysTimers_TIMER_MODE       0
#define SysTimers_TICKS_PER_SECOND 10000
...
#define SysTimers_ACTIVE         0x40000000
...
CY_ISR_PROTO(SysTimers_SysTickISR);
    ...
    #define  SysTimers_SYSTICK_PERIOD     ((BCLK__BUS_CLK__HZ)/10000)
#elif (CY_PSOC4)
    #define  SysTimers_SYSTICK_PERIOD     ((CYDEV_BCLK__HFCLK__HZ)/10000)
#endif /* CY_PSOC5A */
