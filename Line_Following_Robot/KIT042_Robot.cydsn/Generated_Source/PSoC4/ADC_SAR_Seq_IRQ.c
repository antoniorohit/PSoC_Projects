...
*
* Summary:
*   Sets the Priority of the Interrupt. Note calling ADC_SAR_Seq_IRQ_Start
*   or ADC_SAR_Seq_IRQ_StartEx will override any effect this method would 
*   have had. This method should only be called after ADC_SAR_Seq_IRQ_Start or 
*   ADC_SAR_Seq_IRQ_StartEx has been called. To set the initial
