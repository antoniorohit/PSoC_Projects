...
#define ADC_SAR_Seq_intClock_SetDividerRegister(clkDivider, reset)  \
                        ADC_SAR_Seq_intClock_SetFractionalDividerRegister((clkDivider), 0)
#define ADC_SAR_Seq_intClock_SetDivider(clkDivider)           ADC_SAR_Seq_intClock_SetDividerRegister((clkDivider), 1)
#define ADC_SAR_Seq_intClock_SetDividerValue(clkDivider)      ADC_SAR_Seq_intClock_SetDividerRegister((clkDivider) - 1, 1)
