...
#define ADC_SAR_Seq_DEFAULT_DIFF_RESULT_FORMAT_SEL (0u)
...
#define ADC_SAR_Seq_TOTAL_CHANNELS_NUM             (4u)
#define ADC_SAR_Seq_SEQUENCED_CHANNELS_NUM         (4u)
#define ADC_SAR_Seq_DEFAULT_EN_CHANNELS            (7u)
