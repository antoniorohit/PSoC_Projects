...
uint16 CapSense_SensorSignal[CapSense_TOTAL_SENSOR_COUNT] = {0u};
...
/* Helps while centroid calulation */
    ...
    static uint16 CapSense_centroid[3];
#endif  /* (CapSense_TOTAL_CENTROIDS_COUNT) */

const uint16 CYCODE CapSense_fingerThreshold[] = {
    50u, 
};

const uint16 CYCODE CapSense_noiseThreshold[] = {
    1u, 
};

const uint16 CYCODE CapSense_hysteresis[] = {
    10u, 
};
...
const uint8 CYCODE CapSense_rawDataIndex[] = {
    0u, /* ProximitySensor__PROX */

};

const uint8 CYCODE CapSense_numberOfSensors[] = {
    1u, /* ProximitySensor__PROX */
 ...
 void CapSense_UpdateSensorBaseline(uint8 sensor)
{
    ...
    uint8 widget = CapSense_widgetNumber[sensor];
    uint16 noiseThreshold = CapSense_noiseThreshold[widget];
...
uint8 CapSense_CheckIsSensorActive(uint8 sensor)
{
    ...
    uint8 widget = CapSense_widgetNumber[sensor];
    uint16 fingerThreshold = CapSense_fingerThreshold[widget];
    uint16 hysteresis = CapSense_hysteresis[widget];
...
void CapSense_DisableWidget(uint8 widget)
{
    ...
    *******************************************************************************/
        ...
        uint8 CapSense_FindMaximum(uint8 offset, uint8 count, uint16 fingerThreshold, const uint8 CYCODE *diplex)
    #else 
        uint8 CapSense_FindMaximum(uint8 offset, uint8 count, uint16 fingerThreshold)
    #endif /* (CapSense_IS_DIPLEX_SLIDER) */
    {
        ...
        uint8 maximum = 0xFFu;
        uint16 temp = 0u;
        uint16 *startOfSlider = &CapSense_SensorSignal[offset]; 
